  ...
  render() {
    ...
    return (
      <section className="container1__flexbox2">
        <h2 className="flexbox2__comments-header">3 Comments</h2>
          ...
          {comments?.map((comment) => {
            return (
              <div
                ...
                className="display-comments__flexbox"
              >
                <div className="flexbox__avatar-container">
                  <div className="flexbox__avatar"></div>
                </div>

                <div className="flexbox__comment-container">
                  <div className="flexbox__info">
                    <p className="info__name">{comment.name}</p>

                    <div className="info__timestamp">{timestampValue}</div>
                  </div>

                  <p className="flexbox__comment">{comment.comment}</p>
                </div>
              </div>
            );
          })}
